...
test("TC: SALEOR_1 Create basic category #e2e #category", async () => {
...
test("TC: SALEOR_2 Edit category #e2e #category", async () => {
...
test("TC: SALEOR_3 Bulk delete categories #e2e #category", async () => {
  await categoriesPage.gotoCategoryListView();
